...
jQuery(document).ready(function ($) {
  ...
  $(
    ".blaze-commerce-thank-you-wrapper, .blaze-commerce-thank-you-container, .blaze-commerce-thank-you-header, .blaze-commerce-main-content, .blaze-commerce-order-details, .blaze-commerce-addresses-section, .blaze-commerce-account-creation, .blaze-commerce-order-summary"
  ).css({
    opacity: "1 !important",
  ...
  $(
    ".blaze-commerce-thank-you-container, .blaze-commerce-addresses-grid, .blaze-commerce-account-form"
  ).each(function () {
  ...
  function initResendEmail() {
    ...
    $("#resend-email-btn").on("click", function (e) {
      ...
      if (!orderId || !orderKey) {
        showResendEmailFeedback(
          "error",
          "Invalid order data. Please refresh the page and try again."
        );
        return;
      }
      ...
      $.ajax({
        ...
        error: function (xhr, status, error) {
          ...
          const errorMessage =
            blazeCommerceAjax && blazeCommerceAjax.messages
  ...
  function initPrintOrder() {
    ...
    if (!$(".blaze-commerce-print-order-btn").length) {
      const printButton = $(
        '<button class="blaze-commerce-print-order-btn" style="margin-top: 16px; padding: 8px 16px; background: #f8f9fa; border: 1px solid #dee2e6; border-radius: 4px; font-size: 14px; cursor: pointer; width: 100%;">📄 Print Order Details</button>'
      );
  ...
  function initResponsiveBehavior() {
    function handleResize() {
      ...
      if (windowWidth < 1024) {
        ...
        $(".blaze-commerce-addresses-grid").css(
          "grid-template-columns",
          "1fr 1fr"
        );
        $(".blaze-commerce-account-form").css(
          "grid-template-columns",
          "1fr 1fr"
        );
      }

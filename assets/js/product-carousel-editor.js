...
(function() {
    ...
    class ProductCarouselBlock extends Component {
         ...
         */
        onResponsiveChange = (device, value) => {
            const { attributes, setAttributes } = this.props;
        ...
        renderCategoryControls = () => {
            ...
            return el('div', { className: 'blaze-category-checkboxes' },
                categories.map(category =>
                    el(CheckboxControl, {
                        key: category.value,
                        label: category.label,
                        checked: selectedCategories.includes(category.value),
                        onChange: (checked) => this.onCategoryChange(category.value, checked)
                    })
                )
            );
        };
        ...
        renderPreview = () => {
            ...
            return el('div', { className: 'blaze-product-carousel-preview' },
                el('div', { className: 'blaze-preview-content' },
                    __('Product carousel will appear here. Configure settings in the sidebar.', 'blaze-blocksy')
                )
            );
        };
            ...
            return el(Fragment, {},
                ...
                el(InspectorControls, {},
                    ...
                    el(PanelBody, {
                        ...
                        // Category Selection
                        el('div', { className: 'blaze-control-group' },
                            el('h4', { className: 'blaze-control-group-title' },
                                __('Product Categories', 'blaze-blocksy')
                            ),
                            this.renderCategoryControls(),
                            el('p', { className: 'blaze-help-text' },
                                __('Leave empty to show products from all categories', 'blaze-blocksy')
                            )
                        ),
                        ...
                        el(SelectControl, {
                            ...
                            options: [
                                ...
                                { value: 'featured', label: __('Featured Products', 'blaze-blocksy') },
                                { value: 'on_sale', label: __('On Sale Products', 'blaze-blocksy') },
                                { value: 'new', label: __('New Products (Last 30 days)', 'blaze-blocksy') },
                                { value: 'in_stock', label: __('In Stock Products', 'blaze-blocksy') },
                                { value: 'out_of_stock', label: __('Out of Stock Products', 'blaze-blocksy') }
                            ],
                    ...
                    el(PanelBody, {
                        ...
                        el('div', { className: 'blaze-control-group' },
                            ...
                            el('div', { className: 'blaze-responsive-controls' },
                                el(RangeControl, {
                                    label: __('Desktop', 'blaze-blocksy'),
                                    value: productsPerSlide.desktop,
                                    onChange: (value) => this.onResponsiveChange('desktop', value),
                                    min: 1,
                                    max: 8,
                                    step: 1
                                }),
                                el(RangeControl, {
                                    ...
                                    onChange: (value) => this.onResponsiveChange('tablet', value),
                                    min: 1,
                                    max: 6,
                                    step: 1
                                }),
                                el(RangeControl, {
                                    ...
                                    onChange: (value) => this.onResponsiveChange('mobile', value),
                                    min: 1,
                                    max: 4,
                                    step: 1
                                })
                ...
                el('div', blockProps,
                    ...
                    el('div', { className: 'blaze-product-carousel-editor-header' },
                        el('h3', { className: 'blaze-product-carousel-editor-title' },
    ...
    registerBlockType('blaze-blocksy/product-carousel', {
        ...
        description: __('Display WooCommerce products in a responsive carousel slider.', 'blaze-blocksy'),
        icon: 'products',

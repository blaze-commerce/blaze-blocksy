...
(function ($) {
  ...
  $(document).ready(function () {
    ...
    /**
     * CWG In Stock notification panel toggle
    ...
    $(
      ...
      $(this).hide();
      var $panelBody = $(this).next(".cwginstock-panel-body");
      // Add slide class for CSS transitions and toggle open state
      $panelBody.addClass("blaze-slide").toggleClass("is-open");
    });
    ...
    /**
     * Star rating click - scroll to reviews tab
     * Uses native smooth scroll instead of jQuery animate for better performance
     */
    $(document.body).on(
      "click",
      ".woocommerce-product-rating .star-rating",
      function (e) {
        // jump to #reviews then open reviews tab using native smooth scroll

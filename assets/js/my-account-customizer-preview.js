...
(function($) {
    ...
    function initColorPreview() {
        ...
        buttonColors.forEach(function(colorType) {
        ...
        inputColors.forEach(function(colorType) {
            var settingId = 'blocksy_child_my_account_' + colorType;
    ...
    function initSpacingPreview() {
        ...
        paddingSides.forEach(function(side) {
    ...
    function initTemplatePreview() {
        wp.customize('blocksy_child_my_account_template', function(value) {
            value.bind(function(newValue) {

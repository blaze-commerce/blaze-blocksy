...
class BlazeBlocksy_Free_Shipping_Offcanvas_Customizer {
						...
						blocksy_rand_md5() => array(
							...
							'options' => array(
								...
								'free_shipping_offcanvas_content' => array(
									...
									'type' => 'wp-editor',
									'value' => __( '<strong>🎉 Congratulations!</strong> You have qualified for free shipping!', 'blaze-blocksy' ),
	...
	public static function get_content() {
		return get_theme_mod(
			...
			__( '<strong>🎉 Congratulations!</strong> You have qualified for free shipping!', 'blaze-blocksy' )
		);
	}

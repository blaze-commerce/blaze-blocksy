...
class ProductVariationSwatchesBlock {
    ...
    public function enqueue_frontend_assets() {
        ...
        // Enqueue our existing general.js for "view more" functionality
        if (defined('BLAZE_BLOCKSY_URL') && defined('BLAZE_BLOCKSY_PATH')) {
            $general_js_path = BLAZE_BLOCKSY_URL . '/assets/js/general.js';
            if (file_exists(BLAZE_BLOCKSY_PATH . '/assets/js/general.js')) {
                wp_enqueue_script(
                    'blaze-blocksy-general',
                    $general_js_path,
                    array('jquery'),
                    filemtime(BLAZE_BLOCKSY_PATH . '/assets/js/general.js'),
                    true
                );
            }
        }

...
- **Product Image Swap**: Fixed LazyLoad compatibility issue where mouseleave would restore image to blank/base64 placeholder instead of original image
  ...
  - Added event listener for LazyLoad completion to update original image data
  - Enhanced `initHoverImage()` method with robust LazyLoad handling
...
[unreleased]: https://github.com/blaze-commerce/blaze-blocksy/compare/v1.34.0...HEAD

...
### Added
- add product page test and testProducts config
...
### Changed
- bump theme version to 1.65.0 (#199)
- ✅ feat(e2e): add visual comparison test for checkout page
- ✅ feat(e2e): add visual comparison test for category pages
- 🔧 chore: add Claude Code configuration and commands
- ♻️ refactor(e2e): simplify homepage tests to focus on essential assertions
- ✅ feat(e2e): add visual comparison testing for homepage and product pages
- bump theme version to 1.64.0 (#197)
- bump theme version to 1.63.0 (#195)
- bump theme version to 1.62.0 (#193)
- bump theme version to 1.61.0 (#188)
...
### Fixed
- add missing constant, it will cause a problem in customization
- handle Swiper carousel slides in add-to-cart test
- increase wishlist remove button font size to 16px on desktop (#196)
- Improve coupon error message layout on checkout page (#194)
- Update checkout mobile toggle default colors to black and remove border-radius (#192)
...
[1.61.0]: https://github.com/blaze-commerce/blaze-blocksy/compare/v1.45.0...v1.61.0
[1.62.0]: https://github.com/blaze-commerce/blaze-blocksy/compare/v1.45.0...v1.62.0
[1.63.0]: https://github.com/blaze-commerce/blaze-blocksy/compare/v1.45.0...v1.63.0
...
[unreleased]: https://github.com/blaze-commerce/blaze-blocksy/compare/v1.68.0...HEAD
=======
